...
class ResearchRequestTest {
    ...
    void defaultMaxSources_shouldReturn15() {
        var request = new ResearchRequest("test", null, null, null, null);
    ...
    void customMaxSources_shouldReturnCustomValue() {
        var request = new ResearchRequest("test", 5, null, null, null);
        assertEquals(5, request.resolvedMaxSources());
    }

    @Test
    void customChunkSize_shouldReturnCustomValue() {
        var request = new ResearchRequest("test", null, 2, null, null);
    ...
    void customDiscoveryPrompt_shouldReturnCustom() {
        ...
        var request = new ResearchRequest("test", null, null, customPrompt, null);
    ...
    void customSynthesisPrompt_shouldReturnCustom() {
        ...
        var request = new ResearchRequest("test", null, null, null, customPrompt);
        assertEquals(customPrompt, request.resolvedSynthesisPrompt());
    }

    @Test
    void compileReportPrompt_shouldNotBeNull() {
        var request = new ResearchRequest("test", null, null, null, null);
        assertNotNull(request.compileReportPrompt());
    }

    @Test
    void zeroMaxSources_shouldFallbackToDefault() {
        var request = new ResearchRequest("test", 0, null, null, null);
        assertEquals(15, request.resolvedMaxSources());
    }

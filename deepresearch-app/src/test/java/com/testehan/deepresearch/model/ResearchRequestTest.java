...
class ResearchRequestTest {
    ...
    void defaultMaxSources_shouldReturn15() {
        var request = new ResearchRequest(ResearchTopic.NEWS, "test subject", null, null, null, null, null);
    ...
    void customMaxSources_shouldReturnCustomValue() {
        var request = new ResearchRequest(ResearchTopic.NEWS, "test subject", 5, null, null, null, null);
        assertEquals(5, request.resolvedMaxSources());
    }

    @Test
    void customChunkSize_shouldReturnCustomValue() {
        var request = new ResearchRequest(ResearchTopic.NEWS, "test subject", null, 2, null, null, null);
    ...
    void customDiscoveryPrompt_shouldReturnCustom() {
        ...
        var request = new ResearchRequest(ResearchTopic.NEWS, "test subject", null, null, customPrompt, null, null);
    ...
    void customSynthesisPrompt_shouldReturnCustom() {
        ...
        var request = new ResearchRequest(ResearchTopic.NEWS, "test subject", null, null, null, customPrompt, null);
    ...
    void customCompileReportPrompt_shouldReturnCustom() {
        ...
        var request = new ResearchRequest(ResearchTopic.NEWS, "test subject", null, null, null, null, customPrompt);
        assertEquals(customPrompt, request.resolvedCompileReportPrompt());
    }

    @Test
    void zeroMaxSources_shouldFallbackToDefault() {
        var request = new ResearchRequest(ResearchTopic.NEWS, "test subject", 0, null, null, null, null);
        assertEquals(15, request.resolvedMaxSources());
    }
